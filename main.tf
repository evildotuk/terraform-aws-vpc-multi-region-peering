...
resource "aws_route" "acceptor" {
  ...
  vpc_peering_connection_id = join("", aws_vpc_peering_connection_accepter.acceptor.*.id)
  depends_on                = [data.aws_route_tables.acceptor, aws_vpc_peering_connection_accepter.acceptor]
  provider   = aws.peer
}
